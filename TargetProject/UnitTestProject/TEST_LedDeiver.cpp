...
namespace UnitTestProject
{
	...
	public:
		...
		TEST_METHOD(IsOn)
		{
			Assert::IsFalse(LedDriver_IsOn(8), L"LEDÇ™ONèÛë‘");
			LedDriver_TurnOn(8);
			Assert::IsTrue(LedDriver_IsOn(8), L"LEDÇ™OFFèÛë‘");
		}

		TEST_METHOD(IsOff)
		{
			Assert::IsTrue(LedDriver_IsOff(8), L"LEDÇ™ONèÛë‘");
			LedDriver_TurnOn(8);
			Assert::IsFalse(LedDriver_IsOff(8), L"LEDÇ™OFFèÛë‘");
		}
	};
}